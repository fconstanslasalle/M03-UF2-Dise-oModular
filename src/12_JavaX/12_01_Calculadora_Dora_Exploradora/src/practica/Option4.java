...
public class Option4 extends JFrame {
    //Return value for Option3 class

    public Option4() {


    //table content
        String[][] data = {{"11111111.11111111.11111111.11111111", "255.255.255.255", "/32", "", ""},
        ...
        String[] columnNames = {"Binari", "Decimal", "CIDR", "Nº Hosts", "Classe"};;
        //Table Content END
        //Table
        final JTable table = new JTable(data, columnNames);
        table.setPreferredScrollableViewportSize(new Dimension(600, 535));

        //Contenedor de la taula
